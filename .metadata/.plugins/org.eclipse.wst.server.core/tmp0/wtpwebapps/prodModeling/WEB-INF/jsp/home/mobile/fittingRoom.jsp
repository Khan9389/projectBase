				...
				<div class="cont_bodys">
					...
					<div class="item_detail">
						<div class="area_pic">
							<div class="thumb_list_wrap">
								<div class="thumb_nav_wrap" style="display: flex;">
									...
									<div class="sele_fitting">
										<select class="select_home fitting" id="setName" onchange="onSet()">
											<option seleted value="">세트선택하기</option>
						...
						<div class="contents main_recomm">
							<div class="cont_body fitting">
								<div class="fitsec_head">
									<div class="filter action tag_list">
										<button class="btn tab active" onClick="getList('F')">#여성</button>
										<button class="btn tab" onClick="getList('M')">#남성</button>
										<button class="btn tab" onClick="getList('A')">#남여공용</button>
									</div>
								</div>
								...
								<div class="fitsec_body">
									<div class="tagitem active">
										<div class="sec_body_content">
											<!-- 상의 [s] -->
											<div class="swiper-container post-recomm active T">
											...
											<!-- 하의 [s] -->
											<div class="swiper-container post-recomm P">
											...
											<!-- 외투 [s] -->
											<div class="swiper-container post-recomm C">
											...
											<!-- 원피스 [s] -->
											<div class="swiper-container post-recomm D">
												<h5 class="toptitle">원피스</h5>
												<div class="swiper-wrapper" id="D"></div>
											</div>
											<!-- 원피스 [e] -->
											<div class="fitsec_foot">
												<div class="filter action tag_lists">
													<button class="btn tab active" onclick="getType('T')" style="padding: 2.5vw 3.2vw;">상의</button>
													<button class="btn tab" onclick="getType('P')" style="padding: 2.5vw 3.2vw;">하의</button>
													<button class="btn tab" onclick="getType('C')" style="padding: 2.5vw 3.2vw;">외투</button>
													<button class="btn tab" onclick="getType('D')" style="padding: 2.5vw 3.2vw;">원피스</button>
												</div>
											</div>
										</div>
									</div>
...
$(function(){
	...
	$('.tag_lists .btn').click(function(){
		$('.tag_lists .btn').removeClass('active');
		$(this).addClass('active');
	});
...
function getListCB(data){
	...
	for(var i = 0; i < g_dataList.length; i++){
		if(g_dataList[i].PRD_TYP == "T"){
			...
			topHtml += '	<div class="item_prod fitting">';
		...
		if(g_dataList[i].PRD_TYP == "P"){
			...
			pantsHtml += '	<div class="item_prod fitting">';
		...
		if(g_dataList[i].PRD_TYP == "C"){
			...
			outerHtml += '	<div class="item_prod fitting">';
		...
		if(g_dataList[i].PRD_TYP == "D"){
			...
			setHtml += '	<div class="item_prod fitting">';
...
function onSetCB(data){
	...
	if( !cf_isEmpty(data.SET_UPP_PRD) ){
		...
		tHtml += '	<div class="item_prod fitting">';
	...
	if( !cf_isEmpty(data.SET_LOW_PRD) ){
		...
		pHtml += '	<div class="item_prod fitting">';
	...
	if( !cf_isEmpty(data.SET_OTH_PRD) ){
		...
		cHtml += '	<div class="item_prod fitting">';
	...
	if( !cf_isEmpty(data.SET_SET_PRD) ){
		...
		dHtml += '	<div class="item_prod fitting">';
