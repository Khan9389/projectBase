...
<header id="header">
	...
	<div class="common_header">
		<div class="inner">
			...
			<!-- 로고 [e] -->
			<div class="util_group back" style="display:none" onclick="history.back()">
				<div class="arrow"></div>
				<span style="padding: 0;">마이피팅룸</span>
			</div>
...
$(function(){
	...
	console.log(link)
	if(link.includes("fittingRoom")){
		$(".util_group").hide();
		$(".util_group.back").show();
		$(".logo").hide();
	}
})
...
function goShowRoom() {
	...
	location.href="/home/mobile/fittingRoom";
}
